    ...
    <section className="min-h-screen flex flex-col justify-center pt-20 relative overflow-visible">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center mb-6" style={{ opacity: visible ? 1 : 0, transition: "opacity 0.5s ease 0.1s" }}>
            <span className="text-sm font-medium text-muted-foreground px-4 py-1.5 rounded-full" style={{ background: "rgba(255,255,255,0.55)", border: "1px solid rgba(255,255,255,0.7)", backdropFilter: "blur(12px)", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
          ...
          <p className="mt-8 max-w-xl mx-auto leading-relaxed text-xl text-muted-foreground" style={{ opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(16px)", transition: "opacity 0.7s ease 0.5s, transform 0.7s cubic-bezier(0.16,1,0.3,1) 0.5s" }}>
            Paste a job description. Get a tailored resume, cover letter, and application strategy in under 3 minutes.
          </p>

          <div className="flex flex-row items-center justify-center gap-4 mt-10" style={{ opacity: visible ? 1 : 0, transition: "opacity 0.6s ease 0.65s" }}>
