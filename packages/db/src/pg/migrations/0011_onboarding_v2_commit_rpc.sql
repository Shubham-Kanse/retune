...
-- Supabase grants API role access in supabase/migrations/20260517_onboarding_v2_commit_rpc.sql.
-- The package DB migrator also runs against PGlite, which has no Supabase roles by default.
